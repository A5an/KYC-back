...
const (
	createKyc = `INSERT INTO products_kyc (id, product_id, provider_id, first_name, last_name,link, status, nationality, email, phone_number, address) 
VALUES(:id, :product_id, :provider_id, :first_name, :last_name, :link, :status, :nationality, :email, :phone_number, :address)
RETURNING id, product_id, provider_id, first_name, last_name,link, status, nationality, email, phone_number, address`
